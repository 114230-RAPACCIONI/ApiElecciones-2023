[![Review Assignment Due Date](https://classroom.github.com/assets/deadline-readme-button-24ddc0f5d75046c5622901739e7c5dd533143b0c8e959d652212380cedb1ea36.svg)](https://classroom.github.com/a/9_0wgPtG)
...
1. Crear una api que exponga todos los distritos y que permita buscar por nombre. 
...
2. Crear una api que exponga los datos de los cargos disponibles para votar por distrito. 
...
4. Crear una api que exponga un resumen de los resultados (sumatoria total de votos) de una sección y distrito
   ...
   de votos respecto al total del distrito y sección. 
...
5. Crear los Test para que la aplicación tenga un 80 % de cobertura. 

6. Entregar el proyecto con el archivo Dockerfile que permita ejecutar las aplicación en un contenedor.

7. Entregar el proyecto con un archivo docker-compose para poder ehjecutar en simultaneo el contenedor
   del server (la imagen **tupfrcutn/elecciones-2023:1.0.0**) y el cliente (nuestra app) 